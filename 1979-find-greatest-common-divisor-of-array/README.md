...
<ul>
<li>Find the minimum and maximum in one iteration. Let them be mn and mx.</li>
<li>Try all the numbers in the range [1, mn] and check the largest number which divides both of them.</li>
</ul>